...
public class MessagesAndEventsSubscribeAuthorizer extends BaseChatAuthorize {
    public MessagesAndEventsSubscribeAuthorizer(String topic, String clientId, String userId) {
