...
import com.chat.ChatExtensionEntry;
 ...
 * @since 4.0.0
 */
public class GlobalChatListener implements ClientLifecycleEventListener {

    private static final Logger log = LoggerFactory.getLogger(ChatExtensionEntry.class);
